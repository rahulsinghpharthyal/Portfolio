          ...
          {portfolio.map(({ id, src }) => (
            <div key={id} className="shadow-md shadow-gray-600 rounded-lg overflow-hidden">
              ...
              <div className="flex justify-center">
                <button className="w-1/2 py-3 m-4 bg-blue-500 rounded-md text-white hover:bg-blue-600 duration-200 hover:scale-105">Demo</button>
                <button className="w-1/2 py-3 m-4 bg-green-500 rounded-md text-white hover:bg-green-600 duration-200 hover:scale-105">Code</button>
              </div>
            </div>
          ))}
        </div>
